...
// import { StartedNetworkOutputMessage } from '#/schemas/messages/network/output/StartedNetworkOutputMessage.ts'
// import { StatusNetworkOutputMessage } from '#/schemas/messages/network/output/StatusNetworkOutputMessage.ts'
// import { StopNetworkInputMessageInput } from '#/schemas/messages/network/input/StopNetworkInputMessage.ts'
// import { StoppedNetworkOutputMessage } from '#/schemas/messages/network/output/StoppedNetworkOutputMessage.ts'
// import { afterEach, beforeEach, describe, it } from 'std/testing/bdd.ts'
// import { assertOutputMatchesExpected, createClient, createServer, destroyServer, whenClientHasClosed, whenClientHasOpened, } from '#/test/server.ts'
//
// describe('Runtime', () => {
//   beforeEach(async () => {
//     await createServer()
...
//             },
//           }
//           const output: StatusNetworkOutputMessage = {
//             protocol: 'network',
//             command: 'status',
//             payload: {
//               graph: 'foo',
...
//               },
//             }
//             const output: StoppedNetworkOutputMessage = {
//               protocol: 'network',
//               command: 'stopped',
//               payload: {
//                 graph: 'foo',
